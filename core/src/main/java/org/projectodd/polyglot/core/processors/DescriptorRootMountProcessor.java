 ...
 * 
 */
public class DescriptorRootMountProcessor implements DeploymentUnitProcessor {
    
    public static final AttachmentKey<ResourceRoot> DESCRIPTOR_ROOT = AttachmentKey.create(ResourceRoot.class);

    public DescriptorRootMountProcessor(String fileSuffix) {
