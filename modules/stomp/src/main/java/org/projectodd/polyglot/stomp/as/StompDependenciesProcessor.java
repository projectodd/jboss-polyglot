...
public class StompDependenciesProcessor implements DeploymentUnitProcessor {
    ...
    private static ModuleIdentifier POLYGLOT_STOMP_ID = ModuleIdentifier.create("org.projectodd.polyglot.stomp");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (unit.hasAttachment( WebApplicationMetaData.ATTACHMENT_KEY )) {
            addDependency( moduleSpecification, moduleLoader, POLYGLOT_STOMP_ID );
        }
    }
