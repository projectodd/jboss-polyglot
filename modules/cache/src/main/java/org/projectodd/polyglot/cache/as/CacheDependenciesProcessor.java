...
public class CacheDependenciesProcessor implements DeploymentUnitProcessor {
    ...
    private static ModuleIdentifier POLYGLOT_CACHE_ID = ModuleIdentifier.create( "org.projectodd.polyglot.cache" );
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        addDependency( moduleSpecification, moduleLoader, POLYGLOT_CACHE_ID );
